...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">Login to your admin account</h2>
  </div>

  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form action="{{ route('admin.loginCheck') }}"  method="POST" class="space-y-6">
      @csrf
      <div>
    ...
    <p class="mt-10 text-center text-sm/6 text-gray-400">
     New to Account ? 
      <a href="/admin/register" class="font-semibold text-indigo-400 hover:text-indigo-300">Register here</a>
    </p>
  </div>
</div>
</body>
