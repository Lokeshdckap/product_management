...
<head>
    ...
    <link rel="icon" type="image/png" href="{{  asset('logo-new.png')  }}">
...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">Register to  your admin account</h2>
  </div>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form action="{{ route('admin.store') }}" method="POST" class="space-y-6">
      ...
      <div>
        ...
        <div class="mt-2">
          <input id="user_name" type="text" name="name" required autocomplete="user_name" class="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
        </div>
      </div>
      <div>
    ...
    <p class="mt-10 text-center text-sm/6 text-gray-400">
     Aready have a account ? 
      <a href="/admin/login" class="font-semibold text-indigo-400 hover:text-indigo-300">Login here</a>
    </p>
  </div>
</div>
</body>
